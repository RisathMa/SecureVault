    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-4 bg-[#0a0f18] selection:bg-brand-500/30">
      ...
      <div className="w-full max-w-md relative">
        <div className="text-center mb-10">
          <div className="inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-gradient-to-br from-brand-600 to-brand-400 p-[1px] shadow-lg shadow-brand-500/20 mb-6">
